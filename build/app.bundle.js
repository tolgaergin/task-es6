...
/***/ (function(module, exports, __webpack_require__) {
	...
	// Load All Json files
	axios.all([getEmployees(), getAges()]).then(axios.spread(function (getEmployees, getAges) {
	
	  // Defining variables
	  var employees = getEmployees.data;
	  var ages = getAges.data;
	
	  var html = '';
	
	  // Merge two json objects if they have same id
	  var filtered = employees.filter(function (person) {
	
	    return Object.assign(person, ages.find(function (age) {
	      if (person.id === age.id) {
	        return age;
	      }
	    }));
